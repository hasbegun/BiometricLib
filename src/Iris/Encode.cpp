 ...
 */
double Encode::getCoefficientThres(Masek::Complex **E, int w, int h, float rate, int type)
{
 ...
 * IrisLib approach.
 */
double Encode::getMagnitudeThres(Masek::Complex **E, int w, int h, float rate)
{
...
void Encode::newEncode(Masek::filter *polar_array,
                   ...
                   float magLowerThresRate, float magUpperThresRate)
{
    Masek::Complex *** EO, **E1;
	double *filtersum;
	int i, j;
