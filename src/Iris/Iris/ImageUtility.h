...
public:
    ...
    /*
     * @note This is for debuging purpose. Show all tree points upper and lower eye lid points.
     * @param name  windows name
     * @param img   eye image
     * @param x     x values double[3]
     * @param ty    top y values double[3]
     * @param by    bottom y values double[3]
     */
    ...
    /**
     * @brief connectPoints: given multiple points connect them by lines
     * @param eyeImg
     * @param x x-coord values
     * @param ty upper eyelid values
     * @param by lower eyelid values
    ...
    /**
     * convert IplImage to CV2 Mat format
     * @param iplimage  IplImage pointer
     * @param mat       CV2 mat pointer
     */
    static void iplImageToCV2Mat(IplImage *iplimage, cv::Mat *mat);
     ...
     * @param iplimage  IplImage pointer
     */
    static void CVMatToIplImage(cv::Mat *mat, IplImage* iplimage);
