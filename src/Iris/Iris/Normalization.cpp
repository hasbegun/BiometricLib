...
void Normalization::normalizeiris(Masek::filter *image,
                                  ...
                                  Masek::filter *polar_array, Masek::IMAGE *polar_noise)
{
    ...
    ///////////////////////////////////
    //Masek::printfilter(image, "image.txt");
    ///////////////////////////////////
...
//    Masek::printfilter(polar_array, "polar.txt");
//    Masek::printimage(polar_noise, "polar_noise.txt");
