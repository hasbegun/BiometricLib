...
public:
   ...
   /**
    * Load an existing IRIS's template or creates a new template.
	*
	...
	*/
   void loadIrisTemplate(char* fileName, int dataType);
...
private:
	...
	*							- \c 2 = video captured at a distance (distant-videos)
	*/
   void createIrisTemplate(char* fileName, const char* templateFileName, int dataType);
