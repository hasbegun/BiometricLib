#include "ProcessFace.h"        // Easily preprocess face images, for face recognition.
...
Mat getPreprocessedFace(Mat &srcImg, int desiredFaceWidth,
        ...
        Rect *storeFaceRect, Point *storeLeftEye, Point *storeRightEye,
        Rect *searchedLeftEye, Rect *searchedRightEye,
        Mat *FACEIMG, Mat *leftEyeImg, Mat *rightEyeImg)
{
    // Use square faces.
    ...
    if (faceRect.width > 0) {
        ...
        if (leftEye.x >= 0 && rightEye.x >= 0) {
            ...
            // verifing.... display eyes
            //Mat leftEyeImg = gray(*searchedLeftEye);
            //Mat rightEyeImg = gray(*searchedRightEye);
            //imshow("Left Eye", leftEyeImg);
            //imshow("Right Eye", rightEyeImg);

            *leftEyeImg = gray(*searchedLeftEye);
            *rightEyeImg = gray(*searchedRightEye);
            *FACEIMG = faceImg;
            ////
