...
void Encode::fftshift(double *x, int numDims, int size[])
{
	int k;
	int count;
	int i, m, p;
...
void Encode::dft(Masek::Complex *x, Masek::Complex *y, int N)
{
...
Masek::Complex* Encode::fft(Masek::Complex* x, int N)
{
    Masek::Complex *y;
...
Masek::Complex* Encode::ifft(Masek::Complex* x, int N)
{
    Masek::Complex *y;
	int i;
...
void Encode::gaborconvolve(Masek::filter* im, int nscale, int minWaveLength,
